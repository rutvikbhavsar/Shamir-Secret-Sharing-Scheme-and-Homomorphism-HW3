...
public class sss_k_5 {
	...
	public static void main(String args[]) {
		...
		try {
			...
			if (check) {
				...
				do {
					if (k < bmp_h) {
						...
						share[k] = (((bitimg[k]) + (10 * 1) + (10 * 1) + (10 * 1) + (10 * 1)) % 251); // for x = 1,
																										// a1=a2=a3=a4=10
			...
			Path save1 = Paths.get("C:/Users/bhavs/eclipse-workspace/HW_3/src/k=5/share1_out.bmp");
			...
			if (check) {
				...
				do {
					if (k < bmp_h) {
						...
						share[k] = ((bitimg[k]) + (10 * 2)
								+ (10 * (2 * 2) + (10 * (2 * 2 * 2)) + (10 * (2 * 2 * 2 * 2))) % 251); // for x = 2,
																										// a1=a2=a3=a4=10
			...
			Path save2 = Paths.get("C:/Users/bhavs/eclipse-workspace/HW_3/src/k=5/share2_out.bmp");
			...
			if (check) {
				...
				do {
					if (k < bmp_h) {
						...
						share[k] = (((bitimg[k]) + (10 * 3) + (10 * (3 * 3)) + (10 * (3 * 3 * 3))
								+ (10 * (3 * 3 * 3 * 3))) % 251); // for x = 3, a1=a2=a3=a4=10
			...
			Path save3 = Paths.get("C:/Users/bhavs/eclipse-workspace/HW_3/src/k=5/share3_out.bmp");
			...
			if (check) {
				...
				do {
					if (k < bmp_h) {
						...
						share[k] = (((bitimg[k]) + (10 * 4) + (10 * (4 * 4)) + (10 * (4 * 4 * 4))
								+ (10 * (4 * 4 * 4 * 4))) % 251); // for x = 4, a1=a2=a3=a4=10
			...
			Path save4 = Paths.get("C:/Users/bhavs/eclipse-workspace/HW_3/src/k=5/share4_out.bmp");
			...
			if (check) {
				...
				do {
					if (k < bmp_h) {
						...
						share[k] = (((bitimg[k]) + (10 * 5) + (10 * (5 * 5)) + (10 * (5 * 5 * 5))
								+ (10 * (5 * 5 * 5 * 5))) % 251); // for x = 5, a1=a2=a3=a4=10
			...
			Path save5 = Paths.get("C:/Users/bhavs/eclipse-workspace/HW_3/src/k=5/share5_out.bmp");
			...
			if (check) {
				...
				do {
					...
					rec = ((x1[k] * 5) + (x2[k] * (-10)) + (x3[k] * 10) + (x4[k] * (-5)) + (x5[k] * 1)) % 251;
			...
			Path save6 = Paths.get("C:/Users/bhavs/eclipse-workspace/HW_3/src/k=5/final_img_out.bmp");
			Files.write(save6, bitimg);

			long sysstop = System.currentTimeMillis();
			long total = sysstop - systart;
			System.out.println("\nRunning time of the code for the value of k = 5 is: " + total + "ms");
